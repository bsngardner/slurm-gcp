...
| <a name="requirement_google"></a> [google](#requirement\_google) | >= 3.43, < 6.0 |
...
| Name | Version |
|------|---------|
| <a name="provider_google"></a> [google](#provider\_google) | >= 3.43, < 6.0 |
...
| <a name="input_placement_policy"></a> [placement\_policy](#input\_placement\_policy) | instance placement policy | `string` | `null` | no |
